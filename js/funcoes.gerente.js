...
function editarUsuario(id) {
    var htmlFomulario =
        ...
        '<label for="form-cd-us-tipo" class="control-label col-sm-3"> Tipo </label>' +
        '<div class="col-sm-7">' +
        '<select id="form-cd-us-tipo" name="tipo" class="form-control" required="required">' +
        ...
        '</div>' +
        '<div class="form-group">' +
        '<label class="control-label col-sm-3" for="form-cd-us-nome"> Nome </label>' +
        '<div class="col-sm-7">' +
        '<input id="form-cd-us-nome" class="form-control" name="nome" data-minlength="3" data-error="Mínimo 3 e máximo 20 caracteres alfanuméricos" maxlength="20" placeholder="Nome de Usuário" required pattern="[A-Za-zÀ-ú, -,Ã,ã,Õ,õ,ç,Ç]{3,20}" title="Mínimo 3 e máximo 20 caracteres alfanuméricos" value="João da Silva"/>' +
        '<span class="help-block with-errors"></span>' +
        '</div>' +
        '</div>' +
        '<div class="form-group">' +
        '<label class="control-label col-sm-3" for="form-cd-us-email"> E-mail </label>' +
        '<div class="col-sm-7">' +
        '<input id="form-cd-us-email" class="form-control" type="email" name="email" placeholder="Email do usuário" required="required" value="joao.silva@mail.com"/>' +
        '<span class="help-block with-errors"></span>' +
        '</div>' +
        '</div>' +
        '<div class="form-group">' +
        '<label class="control-label col-sm-3" for="form-cd-us-telefone"> Telefone </label>' +
        '<div class="col-sm-7">' +
